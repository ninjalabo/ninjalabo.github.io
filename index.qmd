...
::: {.hero-buttons}
[Get Started](http://51.15.135.247:8501/){.btn-action-primary .btn-action .btn .btn-success .btn-lg role="button"}
[Request Demo](https://forms.gle/zKjaeEzqoVu7a9vQ8){#btn-guide .btn-action .btn .btn-light .btn-lg role="button"}
:::

:::
<video id="myVideo" autoplay muted playsinline loop controls style="width: 70%; height: auto; display: block; margin: 0 auto;">
